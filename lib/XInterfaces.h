...
typedef void (*app_buffer_callback)(int type, char* buffer, int w, int h, int size);
...
{
public:
    virtual void init(app_logger_callback logger) = 0;

    virtual void createCamSource(char* name, int pref_w, int pref_h, app_buffer_callback func) = 0;
