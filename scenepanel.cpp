...
void CScenePanel::rePosition()
{
    ...
    // параметры сетки
    zh = 3; // высота зазора между строками (два зазора также делается от гор.границ всей области)
    zw = 3; // ширина зазора между столбцами (два зазора также делается слева и справа от всей области)
    w = w - 2*zw;
    h = h - 2*zh;
